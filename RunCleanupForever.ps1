...
{
$timeout_seconds = 600 #max time in seconds allowed for macro to complete. Change this value if  your macros takes longer to run.
$macro_name = "COS Clean Up (Play me!)"
$path_downloaddir = "C:\Users\troy.day\Downloads\" #Where the script finds the kantu log files => *THIS MUST BE THE BROWSER DOWNLOAD FOLDER*, as specified in the browser settings
$path_autorun_html = "C:\Users\troy.day\Downloads\" + $macro_name + ".html" #Any autorun page exported from Kantu. A page for any macro will do, as we use the &macro= switch anyway.
$variables = "&cmd_var1=true&cmd_var2=true"
...
$arg = """file:///"+ $path_autorun_html + "?macro=" + $macro + $variables + "&direct=1&savelog="+$log+""""
...
$testreport = $path_downloaddir + "testreport.txt"
...
$result = PlayAndWait $macro_name  #run the macro
